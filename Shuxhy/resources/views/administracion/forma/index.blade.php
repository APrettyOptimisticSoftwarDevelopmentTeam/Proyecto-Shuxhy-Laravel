			...
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($formas as $forma)
				<tr>  <!-- Aqui se establecen los datos  -->
					...
					<td>
						<a href="{{URL::action('FormaController@edit',$forma->IdForma)}}"><button class="btn btn-info">Editar</button></a>
                         <a href="" data-target="#modal-delete-{{$forma->IdForma}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>
					</td>
				</tr>
