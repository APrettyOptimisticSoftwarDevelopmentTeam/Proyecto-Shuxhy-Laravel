...
@section ('contenido')
			...
			{!!Form::open(array('url'=>'reportes/ventas','method'=>'CREATE','autocomplete'=>'off'))!!}
            {{Form::token()}}
...
<div class="row">
                              ...
                              <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                                    ...
                                    <div class="form-group">
                                          <button type="button" id="bt_add" class="btn btn-primary"><a href="{{url('reportes/ventas/displayreport')}}">Generar</a></button>
